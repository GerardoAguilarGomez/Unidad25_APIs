...
namespace API3
{
    ...
    public class CajasController : ControllerBase
    {
        ...
        private static readonly Expression<Func<Caja, CajasDTO>> asCajaDto = x => new CajasDTO
        {
            NumReferencia = x.NumReferencia,
        ...
        [HttpGet("~/api/Caja/{contenido}")]
        public IQueryable<CajasDTO> GetArticuloNombre(string nombre)
        {
            return _context.Cajas.Where(e => e.Contenido.Equals(nombre, StringComparison.OrdinalIgnoreCase)).Select(asCajaDto);
        }
    }
}
