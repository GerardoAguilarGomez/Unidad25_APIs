...
namespace API3.Controllers
{
    ...
    public class AlmacenesController : ControllerBase
    {
        ...
        private static readonly Expression<Func<Almacen, AlmacencesDTO>> asAlmacenDto = x => new AlmacencesDTO
        {
            Codigo = x.Codigo,
            Lugar = x.Lugar,
        ...
        [HttpGet("~/api/Almacen/{lugar}")]
        public IQueryable<AlmacencesDTO> GetArticuloNombre(string lugar)
        {
            return _context.Almacenes.Where(e => e.Lugar.Equals(lugar, StringComparison.OrdinalIgnoreCase)).Select(asAlmacenDto);
        }
    }
}
