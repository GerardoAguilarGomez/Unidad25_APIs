...
namespace API4.Controllers
{
    ...
    public class SalasController : ControllerBase
    {
        ...
        private static readonly Expression<Func<Sala, SalasDTO>> asSalaDto = x => new SalasDTO
        {
            Codigo = x.Codigo,
            Nombre = x.Nombre,
            CodigoPelicula = x.CodigoPelicula
        };
        ...
        [HttpGet("~/api/Sala/{nombre}")]
        public IQueryable<SalasDTO> GetSalaNombre(string nombre)
        {
            return _context.Salas.Where(e => e.Nombre.Equals(nombre, StringComparison.OrdinalIgnoreCase)).Select(asSalaDto);
        }
    }
}
